            ...
            <div class="row">
                ...
                <div class="lblinput">
                    ...
                    <input type="number" name="math"
                        value="<?php echo isset($_POST['math']) ? $_POST['math'] : "" ; ?>"max="10" min="0" />
                </div>
            </div>
            <!-- Physics -->
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="lblinput">
                    <input type="number" name="chemistry"
                        value="<?php echo isset($_POST['chemistry']) ? $_POST['chemistry'] : "" ; ?>"max="10" min="0" />
                </div>
            </div>
            <div class="row">
        <div class="lbltitle">
...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="lbloutput">
            <?php
            if (isset($_POST['btnsubmit'])) { $priority_points = $_POST['area']; switch ($priority_points) {
            case 1:
            echo "1"; 
            break;
            case 2:
